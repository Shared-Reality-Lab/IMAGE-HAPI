...
class Device{
  ...
  */	
    ...
    device_read_data (){
        ...
        const device_data = this.deviceLink.receive(communicationType, this.deviceID, this.sensorsActive + this.encodersActive);
...
//                 System.arraycopy(this.motors, 0, temp, 0, this.motors.length);
                
//                 if(j < this.actuatorsActive){
//                     System.arraycopy(this.motors, j, temp, j+1, this.motors.length - j);
//                 }
...
//                     System.arraycopy(this.encoders, 0, temp, 0, encoders.length);
              
//                     if(j < encodersActive){
//                         System.arraycopy(this.encoders, j, temp, j+1, encoders.length - j);
//                     }
...
//                     console.log("warning, improper encoder indexing");
//                     this.encoders[i].set_encoder(i+1);
//                     this.encoderPositions[this.encoders[i].get_port() - 1] = encoders[i].get_encoder();
//                 }
//             }
...
//         if(this.actuatorsActive > 0){
//       motorParams = new byte[this.actuatorsActive + 1];
//             control = 0;
...
//                     console.log("warning, improper actuator indexing");
//                     this.motors[i].set_actuator(i+1);
//                     this.actuatorPositions[motors[i].get_port() - 1] = this.motors[i].get_actuator();
//                 }
//             }
...
//       pwmParams = new Uint8Array(pwmsActive + 1);
//       pwmParams[0] = this.pwmsActive;

function Device(deviceID, deviceLink){
    this.deviceID = deviceID;
	this.deviceLink = deviceLink;

    var actuator_assignment = function(actuator, port){
  ...
  */	
	var encoder_assignment= function (encoder, port){
...
Device.prototype.add_actuator = function(actuator, rotation, port){
	let error = false;
        ...
        Device.prototype.add_encoder = function(encoder, rotation, offset, resolution, port){
            let error = false;
            ...
            Device.prototype.add_analog_sensor = function (pin){
...
Device.prototype.add_pwm_pin = function (pin){
...
Device.prototype.set_mechanism = function(mechanism){
    this.mechanism = mechanism;
}

Device.prototype.device_set_parameters = function(){
...
Device.prototype.device_read_data = function(){
    communicationType = 2;
    let dataCount = 0;
...
Device.prototype.device_read_request = function(){
    communicationType = 2;
...
Device.prototype.device_write_torques= function(){
    communicationType = 2;
    const pulses = new Uint8Array[pwmsActive];
...
Device.prototype.set_pwm_pulse = function(pin, pulse){
...
Device.prototype.get_pwm_pulse = function(pin){
...
Device.prototype.get_device_angles= function(){
...
Device.prototype.get_sensor_data = function(){
...
Device.prototype.get_device_position = function(angles){
...
Device.prototype.set_device_torques = function(forces){
